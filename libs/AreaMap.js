...
var AreaMap = function (provinceid, cityid) {
    ...
    map[23] = new comefrom("四川", "成都|绵阳|德阳|自贡|攀枝花|广元|内江|乐山|南充|宜宾|广安|达川|雅安|眉山|甘孜|凉山|泸州|遂宁");
    ...
    function comefrom(provinces, citys) {
        this.provinces = provinces; this.citys = citys;
    }
